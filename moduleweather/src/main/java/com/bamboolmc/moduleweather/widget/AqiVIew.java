...
public class AqiView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(getFitSize(20));
        paint.setStyle(Paint.Style.STROKE);

        //外线
        float center = width/2;
        float radius = height -getFitSize(100);
        RectF rect = new RectF(center-radius+getFitSize(40),center-radius,center+radius-getFitSize(40),center+radius-getFitSize(40));
        paint.setAlpha(100);
        ...
        canvas.drawText(progress+"",center,radius+getFitSize(20),paint);
